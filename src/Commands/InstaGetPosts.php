...
class InstaGetPosts extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'social:insta:pending';
     ...
     * @var string
     */
    protected $description = 'Get ~FETCH_LIMIT posts for every user pending in DB';
    ...
    public function handle()
    {
        ...
        $users = InstaUser::where('status','=','pending')->orwhere('status','=','FOUND')->get();
